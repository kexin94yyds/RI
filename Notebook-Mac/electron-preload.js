...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  zoom: {
    ...
    getLevel: () => webFrame.getZoomFactor(),
    setLevel: (factor) => webFrame.setZoomFactor(factor),
    resetWindowSize: () => ipcRenderer.invoke('note-reset-size')
  },
  ...
  backup: {
    ...
    getDir: () => ipcRenderer.invoke('backup-dir')
  },
